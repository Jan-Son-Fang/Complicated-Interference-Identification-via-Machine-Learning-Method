...
for i=1:20
    ...
    C1(i)=FrequencyDomainMomentKurtosisCoefficient(J_normal);
end
semilogy(JNR,C1)
hold on
...
for i=1:20
    ...
    J_normal=normalization(J);
    C2(i)=FrequencyDomainMomentKurtosisCoefficient(J_normal);
end
semilogy(JNR,C2)
hold on
...
for i=1:20
    ...
    J_normal=normalization(J);
    C3(i)=FrequencyDomainMomentKurtosisCoefficient(J_normal);
end
semilogy(JNR,C3)
hold on
...
for i=1:20
    ...
    J_normal=normalization(J);
    C4(i)=FrequencyDomainMomentKurtosisCoefficient(J_normal);
end
semilogy(JNR,C4)
hold on
...
for i=1:20
    ...
    J_normal=normalization(J);
    C5(i)=FrequencyDomainMomentKurtosisCoefficient(J_normal);
end
semilogy(JNR,C5)
