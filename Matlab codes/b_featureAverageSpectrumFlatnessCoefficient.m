...
for i=1:20
    ...
    C1(i)=AverageSpectrumFlatnessCoefficient(J_normal);
end
semilogy(JNR,C1)
hold on
...
for i=1:20
    ...
    J_normal=normalization(J);
    C2(i)=AverageSpectrumFlatnessCoefficient(J_normal);
end
semilogy(JNR,C2)
hold on
...
for i=1:20
    ...
    J_normal=normalization(J);
    C3(i)=AverageSpectrumFlatnessCoefficient(J_normal);
end
semilogy(JNR,C3)
hold on
...
for i=1:20
    ...
    J_normal=normalization(J);
    C4(i)=AverageSpectrumFlatnessCoefficient(J_normal);
end
semilogy(JNR,C4)
hold on
...
for i=1:20
    ...
    J_normal=normalization(J);
    C5(i)=AverageSpectrumFlatnessCoefficient(J_normal);
end
semilogy(JNR,C5)
